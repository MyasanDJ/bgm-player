...
const mainAudio=isMobile?nativeAudio:audio;
...
async function startAudio(){
  ...
  try{await mainAudio.play()}catch(e){alert("再生できません。音声ファイル名を確認してください。")}
}
...
moveBtn.onclick=()=>{if(isMobile)return;player.classList.toggle("moveMode");moveBtn.classList.toggle("active")};
